        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FullName_Name = table.Column<string>(maxLength: 100, nullable: true),
                    FullName_Surname = table.Column<string>(maxLength: 200, nullable: true),
                    Email_Address = table.Column<string>(maxLength: 300, nullable: true),
            ...
            migrationBuilder.InsertData(
                schema: "User",
                table: "Users",
                columns: new[] { "Id", "AuthId", "Status", "Email_Address", "FullName_Name", "FullName_Surname" },
